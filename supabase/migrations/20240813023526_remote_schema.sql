...
CREATE POLICY "Allow authenticated users All operations" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users All operations" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users for All operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
